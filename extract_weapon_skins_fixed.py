#!/usr/bin/env python3
"""
Extract weapon skins from multiple sources to build comprehensive skin mappings.
This script tries Price Empire API first, then falls back to Steam Market and local database.
"""
...
async def fetch_from_steam_market():
